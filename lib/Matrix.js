...
class Matrix extends JavaClass {
    ...
    static getScaleInstance(sx, sy) {
        return new Matrix(javaImports.Matrix.getScaleInstanceSync(sx, sy));
    }
    ...
    static getTranslateInstance(tx, ty) {
        return new Matrix(javaImports.Matrix.getTranslateInstanceSync(tx, ty));
    }
    ...
    static getRotateInstance(theta, tx, ty) {
        return new Matrix(javaImports.Matrix.getRotateInstance(theta, tx, ty));
    }
     ...
     */
    rotate(theta) {
        this.javaClass.rotateSync(theta);
    }
    ...
    setValue(row, column, value) {
        this.javaClass.setValueSync(row, column, value);
    }
     ...
     */
    scale(sx, sy) {
        this.javaClass.scaleSync(sx, sy);
    }
     ...
     */
    translate(tx, ty) {
        this.javaClass.translateSync(tx, ty);
    }
