...
class PDPageContentStream extends JavaClass {
    ...
    static create(document, sourcePage) {
        return new PDPageContentStream(new javaImports.PDPageContentStream(document.javaClass, sourcePage.javaClass));
    }
    ...
    addRect(x, y, width, height) {
        this.javaClass.addRectSync(
            java.newFloat(x),
            java.newFloat(y),
            java.newFloat(width),
            java.newFloat(height)
        );
    }
     ...
     */
    lineTo(x, y) {
        this.javaClass.lineToSync(java.newFloat(x), java.newFloat(y));
    }
     ...
     */
    moveTo(x, y) {
        this.javaClass.moveToSync(java.newFloat(x), java.newFloat(y));
    }
    ...
    newLineAtOffset(tx, ty) {
        this.javaClass.newLineAtOffsetSync(java.newFloat(tx), java.newFloat(ty));
    }
    ...
    setFont(font, fontSize) {
        this.javaClass.setFontSync(font, java.newFloat(fontSize));
    }
     ...
     */
    setLeading(leading) {
        this.javaClass.setLeadingSync(java.newFloat(leading));
    }
    ...
    setStrokingColorCMYK(c, m, y, k) {
        this.javaClass.setStrokingColorSync(
            java.newFloat(c),
            java.newFloat(m),
            java.newFloat(y),
            java.newFloat(k)
     ...
     */
    setStrokingColorG(g) {
        this.javaClass.setStrokingColorSync(java.newFloat(g));
    }
    ...
    setNonStrokingColorCMYK(c, m, y, k) {
        this.javaClass.setNonStrokingColorSync(
            java.newFloat(c),
            java.newFloat(m),
            java.newFloat(y),
            java.newFloat(k)
    ...
    setNonStrokingColorG(g) {
        this.javaClass.setNonStrokingColorSync(java.newFloat(g));
    }
    ...
    setLineWidth(lineWidth) {
        this.javaClass.setLineWidthSync(java.newFloat(lineWidth));
    }
    ...
    setLineDashPattern(pattern, phase) {
        this.javaClass.setLineDashPatternSync(pattern, java.newFloat(phase));
    }
    ...
    setMiterLimit(miterLimit) {
        this.javaClass.setMiterLimitSync(java.newFloat(miterLimit));
    }
    ...
    setCharacterSpacing(spacing) {
        this.javaClass.setCharacterSpacingSync(java.newFloat(spacing));
    }
    ...
    setWordSpacing(spacing) {
        this.javaClass.setWordSpacingSync(java.newFloat(spacing));
    }
    ...
    setHorizontalScaling(scale) {
        this.javaClass.setHorizontalScalingSync(java.newFloat(scale));
    }
     ...
     */
    writeOperand(real) {
        this.javaClass.writeOperandSync(java.newFloat(real));
    }
}
